...
import "../SocialBox/social.css";

function ArticleSocialBox({ article }) {
      ...
      {article && (
        <div className="social-post-box">
          <Row>
            ...
            <Col xs={24} md={24}>
              <p className="post-text">{parse(article?.content)}</p>
            </Col>
          </Row>
...
export default ArticleSocialBox;
