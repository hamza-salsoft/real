...
function SpManagement() {
  ...
  const [serviceProviders, setServiceProviders] = useState([
    { id: 1, bookName: "kuame300 Book", authorName: "Alex James" },
    { id: 2, bookName: "kuame300 Book", authorName: "Alex James" },
    { id: 3, bookName: "kuame300 Book", authorName: "Alex James" },
  ...
  const handleStatus = async () => {
    try {
      const index = serviceProviders.findIndex(
