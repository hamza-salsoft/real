...
function ServicesManagement() {
  ...
  const resetFilter = () => {
    ...
    getServices(paginationConfig.pageNumber, paginationConfig.limit, "", true);
  };
  ...
  const handleStatus = async () => {
    try {
      ...
      const response = await Get(
        SERVICE.toggleStatus + "/" + selectedService._id,
        token,
        {}
      );
  ...
  const getServices = async (pageNumber, pageSize, search, reset = false) => {
    setLoading(true);
    try {
    ...
    },
    {
      ...
      render: (item) => (
        <FaEye
          ...
          onClick={() => navigate("/online-services/" + item)}
        />
      ),
    },
  ];
    ...
    <Layout className="configuration">
      <div className="boxDetails">
        <Row style={{ padding: "10px 20px" }}>
          ...
          >
            <h1 className="pageTitle">Service Management</h1>
          </Col>
          <Col
            xs={24}
            md={12}
          ...
          >
            <Button
              ...
              className="mainButton primaryButton"
              onClick={() => navigate("/online-services/addNewService")}
            >
              Add Service
            </Button>
          </Col>
            ...
            <Input
              ...
              suffix={
                <FaSearch
                  ...
                  onClick={() =>
                    getServices(1, paginationConfig.limit, filter.keyword)
                  }
                />
              }
              onPressEnter={(e) =>
