...
import { useGetCoinLogsQuery } from "../../api/transaction";
...
function TransactionLogs() {
  ...
  const { data: coinLogs, refetch } = useGetCoinLogsQuery({ userId, page, limit });
  ...
  const message = `Showing records ${endIndex} of ${coinLogs?.totalDocs}`;
      ...
      <div className="boxDetails">
        <Row style={{ padding: "10px 20px" }}>
          ...
          >
           ...
           <h1 className="pageTitle">Transaction Logs</h1>
            </div>
